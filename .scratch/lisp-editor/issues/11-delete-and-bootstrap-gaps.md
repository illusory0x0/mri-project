...
**What to address:** Two capabilities promised by the user stories are not actually available, discovered while trying to add coverage tasks. Both block measuring `ast-edit` expressiveness.
