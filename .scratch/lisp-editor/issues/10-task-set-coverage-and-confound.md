...
- Add tasks that are easy to state but hard to edit safely as text: wrap a large nested span, move a subtree across a deep parent, insert a form deep inside nested parens. The goal is to actually produce bracket mismatches in `direct`/`text-edit`.
