...
- **`docs/README.md`**: the documentation map, to see which doc owns what.
...
│   ├── 0001-...
│   └── ...
├── eval/          # experiment harness (tasks, arms, scorer, report)
├── src/           # lisp-editor CLI
└── test/          # CLI-level integration tests
```
...
> _Contradicts ADR-0007 (purely syntactic, no semantics), but worth reopening because…_
